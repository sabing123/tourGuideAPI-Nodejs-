...
router.post('/register',(req, res, next)=>{
    ...
    router.get('/me', auth.verifyUser, (req, res, next)=>{
        res.json({ firstname: req.user.firstname, lastname: req.user.lastname, UserName: req.user.username,address:req.user.address,dateofbirth:req.user.dateofbirth,gender:req.user.gender,image:req.user.image })
        })
